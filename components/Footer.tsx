        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/explore" className="text-gray-300 hover:text-white">Explore Jobs</Link></li>
              <li><Link href="/portals" className="text-gray-300 hover:text-white">All Portals</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/how-we-verify" className="text-gray-300 hover:text-white">Learn how we verify our 100+ job portals</Link></li>
