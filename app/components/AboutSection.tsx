import { Heart, Lightbulb, HandHeart, CheckCircle } from 'lucide-react';
    ...
    <section className="bg-white py-16 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold animated-gradient-text mb-4">About MilegaJob</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="text-center p-4 rounded-lg transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg">
          ...
          <div className="text-center p-4 rounded-lg transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg">
            <div className="bg-gradient-to-r from-indigo-700 to-indigo-600 rounded-lg p-6 mb-4">
          ...
          <div className="text-center p-4 rounded-lg transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg">
            <div className="bg-gradient-to-r from-purple-700 to-purple-500 rounded-lg p-6 mb-4">
